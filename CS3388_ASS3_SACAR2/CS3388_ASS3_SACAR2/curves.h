...
public:
    ...
    double getBetaBlendingFunction(double skew, double tension, double tau) const;
    ...
    //returns the blendingfunction for the given tau values
    double getBlendingFunction(double tau) const;
